...
class Interface(object):
    ...
    def __init__(self, description):
        ...
        self.parser.add_argument('--tau', metavar='tau', type=int,
                    required=False, help='hours', default=0)
    ...
    def get_args(self):
        ...
        return {'datetime': args.datetime, 'config': args.config,
                'date': idate, 'time': itime, 'tau': args.tau,
                'time_dt': time_dt}
