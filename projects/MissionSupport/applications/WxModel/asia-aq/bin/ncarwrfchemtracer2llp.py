...
def append_lml(nc, zlib=False):
    ...
    """
    for v in ['tr17_r01', 'tr17_r02', 'tr17_r03', 'tr17_r04', 'tr17_r05', 'tr17_r06',
              'tr17_r07', 'tr17_r08', 'tr17_r09', 'tr17_r10', 'tr17_point', 'tr17_shp', 'rho']:
        var = nc.variables[v]
...
def append_vars(nc, zlib=False): 
    ...
    co = nc.variables['tr17_r01'][0,:,:,:]  # ppmv
    for v in ['tr17_r02', 'tr17_r03', 'tr17_r04', 'tr17_r05', 'tr17_r06', 'tr17_r07', 'tr17_r08', 'tr17_r09', 'tr17_r10']:
        co = co + nc.variables[v][0,:,:,:]
    co = co/1e6*28.0/28.97 # kg kg-1
    nz, ny, nx = co.shape

    no = nc.variables['tr17_point'][0,:,:,:]
    for i in ['tr17_shp']:
        no = no + nc.variables[i][0,:,:,:]
    no = no/1e6*30.0/28.97    
    nz, ny, nx = no.shape
    ...
    this.missing_value = UNDEF # out of domain
    this.units = 'kg m-2'
    this[0,:,:] = npy.sum(no*rho*dz, axis=0)  # kg m-2
