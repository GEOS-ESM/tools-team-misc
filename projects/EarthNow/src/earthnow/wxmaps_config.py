...
class StyleConfig:
    ...
    seaice_alpha: float = 0.9  # Max opacity for fully ice-covered pixels
    seaice_threshold: float = (
        0.15  # Minimum concentration to render (standard 15% cutoff)
    )
    ...
    nws_warning_outline_width: float = (
        1.0  # Warnings get this value, watches/advisories get 0.5x
    )
...
class ResolutionConfig:
    ...
    def __post_init__(self):
        ...
        if not np.isclose(aspect, 16 / 9, rtol=0.01):
            raise ValueError(
                f"Resolution must have 16:9 aspect ratio. Got {aspect:.3f}"
            )
...
class WxMapsConfig:
    ...
    RESOLUTIONS = {
        ...
        "4k": ResolutionConfig(
            name="4K (2160p)", width=3840, height=2160, dpi=200, figsize=(19.2, 10.8)
        ),
        "8k": ResolutionConfig(
            name="8K (4320p)", width=7680, height=4320, dpi=400, figsize=(19.2, 10.8)
        ),
        "fhd": ResolutionConfig(
            name="Full HD", width=1920, height=1080, dpi=120, figsize=(16.0, 9.0)
        ),
        "2k": ResolutionConfig(
            name="2K", width=2560, height=1440, dpi=150, figsize=(17.067, 9.6)
        ),
    }
    ...
    def scale_style_for_resolution(style: StyleConfig, resolution: str) -> StyleConfig:
        ...
        """
        scale_factors = {"hd": 1.0, "fhd": 1.0, "2k": 1.5, "4k": 2.0, "8k": 4.0}
    ...
    def get_northamerica_map() -> MapConfig:
        ...
        return MapConfig(
            ...
            projection=ccrs.LambertConformal(
                central_longitude=-100, central_latitude=35, standard_parallels=(33, 45)
            ),
            extent=extent,
            center_lon=-100,
            center_lat=35,
    ...
    def get_conus_map() -> MapConfig:
        ...
        return MapConfig(
            name="conus",
            projection=ccrs.LambertConformal(
                central_longitude=-97, central_latitude=30, standard_parallels=(33, 45)
            ),
            extent=extent,
            center_lon=-96,
            center_lat=37,
    ...
    def get_conus_west_map() -> MapConfig:
        ...
        return MapConfig(
            name="conus_west",
            projection=ccrs.LambertConformal(
                central_longitude=-115, central_latitude=40, standard_parallels=(33, 45)
            ),
            extent=extent,
            center_lon=-115,
            center_lat=40,
    ...
    def get_conus_northwest_map() -> MapConfig:
        ...
        return MapConfig(
            ...
            projection=ccrs.LambertConformal(
                central_longitude=-116, central_latitude=45, standard_parallels=(40, 50)
            ),
            extent=extent,
            center_lon=-116,
            center_lat=45,
    ...
    def get_great_plains_map() -> MapConfig:
        ...
        return MapConfig(
            name="great_plains",
            projection=ccrs.LambertConformal(
                central_longitude=-98, central_latitude=40, standard_parallels=(35, 45)
            ),
            extent=extent,
            center_lon=-98,
            center_lat=40,
    ...
    def get_europe_map() -> MapConfig:
        ...
        return MapConfig(
            name="europe",
            projection=ccrs.LambertConformal(
                central_longitude=12.5, central_latitude=53, standard_parallels=(40, 60)
            ),
            extent=extent,
            center_lon=12.5,
            center_lat=53,
    ...
    def get_europe_west_map() -> MapConfig:
        ...
        return MapConfig(
            name="europe_west",
            projection=ccrs.LambertConformal(
                central_longitude=1.5, central_latitude=50, standard_parallels=(40, 55)
            ),
            extent=extent,
            center_lon=1.5,
            center_lat=50,
    ...
    def get_europe_east_map() -> MapConfig:
        ...
        return MapConfig(
            name="europe_east",
            projection=ccrs.LambertConformal(
                central_longitude=27.5, central_latitude=52, standard_parallels=(45, 58)
            ),
            extent=extent,
            center_lon=27.5,
            center_lat=52,
    ...
    def get_north_atlantic_map() -> MapConfig:
        ...
        return MapConfig(
            name="north_atlantic",
            projection=ccrs.Stereographic(central_longitude=-32.5, central_latitude=45),
            extent=extent,
            center_lon=-32.5,
            center_lat=45,
        )
    ...
    def get_north_pacific_map() -> MapConfig:
        ...
        return MapConfig(
            name="north_pacific",
            projection=ccrs.Stereographic(central_longitude=-140, central_latitude=35),
            extent=extent,
            center_lon=-140,
            center_lat=35,
        )
    ...
    def get_goes_east_full_disk() -> MapConfig:
        ...
        return MapConfig(
            ...
            projection=ccrs.Geostationary(
                central_longitude=-75.0, satellite_height=35786023.0, sweep_axis="x"
            ),
            extent=extent,
            center_lon=-75.0,
        )
    ...
    def get_goes_west_full_disk() -> MapConfig:
        ...
        return MapConfig(
            ...
            projection=ccrs.Geostationary(
                central_longitude=-137.0, satellite_height=35786023.0, sweep_axis="x"
            ),
            extent=extent,
            center_lon=-137.0,
        )
