...
CONUS2KMFC_URI = env_path("EARTHNOW_CONUS2KMFC_URI",
...
GEOS_FP_URI = env_path("EARTHNOW_GEOS_FP_URI",
...
_G6DEV_PUB  = env_path("EARTHNOW_G6DEV_PUB",
                                   "/discover/nobackup/projects/gmao/g6dev/pub")
_OSSE2_ROOT = env_path("EARTHNOW_OSSE2_ROOT",
                                   "/discover/nobackup/projects/gmao/osse2")
_GMAO_OPS   = env_path("EARTHNOW_GMAO_OPS",
                                   "/discover/nobackup/projects/gmao/gmao_ops/pub")
_CITIES_DIR = env_path("EARTHNOW_CITIES_DIR",
                                   "/home/wputman/IDL_BASE/CITIES")

# ---------------------------------------------------------------------------
# Derived constants
# ---------------------------------------------------------------------------
COLORTABLE_DIR    = env_path("EARTHNOW_COLORTABLE_DIR",
                                _G6DEV_PUB / "ColorTables")
COLORBAR_OUT_DIR  = env_path("EARTHNOW_COLORBAR_OUT_DIR",
                                _G6DEV_PUB / "WxMaps" / "ColorBars")
BASE_IMAGE_DIR    = env_path("EARTHNOW_BASE_IMAGE_DIR",
                                _G6DEV_PUB / "BMNG")
GSHHS_DIR         = env_path("EARTHNOW_GSHHS_DIR",
                                _OSSE2_ROOT / "GSHHG" / "v2.3.7")
NWS_SHAPEFILE_DIR = env_path("EARTHNOW_NWS_SHAPEFILE_DIR",
                                _OSSE2_ROOT / "TSE_staging" / "SHAPE_FILES" / "ALL")
LCC_GRID_FILE     = env_path("EARTHNOW_LCC_GRID_FILE",
                                _OSSE2_ROOT / "stage" / "BCS_FILES" / "lambert_grid.nc4")

# Experiment / data reader defaults
DEFAULT_HWT_EXP_PATH     = env_path("EARTHNOW_DEFAULT_HWT_EXP_PATH",
                                _OSSE2_ROOT / "HWT")
DEFAULT_GENCAST_EXP_PATH = env_path("EARTHNOW_DEFAULT_GENCAST_EXP_PATH",
                                _OSSE2_ROOT / "GenCast_FP")
DEFAULT_GEOS_FP_BASE     = env_path("EARTHNOW_DEFAULT_GEOS_FP_BASE",
                                _GMAO_OPS)
